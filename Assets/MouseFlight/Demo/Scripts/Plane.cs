...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            float keyboardRoll = 0f; //Input.GetAxis("Horizontal");
            float horz = Input.GetAxis("Horizontal")*100;
            ...
            // print("MY: "+controller.MouseAimPos.y);
            // print("MZ: "+controller.MouseAimPos.z);
            // Vector3 flyTarg =new Vector3(controller.MouseAimPos.x+horz,controller.MouseAimPos.y,controller.MouseAimPos.z);
            Vector3 flyTarg =new Vector3(controller.MouseAimPos.x+horz,285.0f,controller.MouseAimPos.z);
            // Calculate the autopilot stick inputs.
            float autoYaw = 0f;
            float autoPitch = 0f;
            float autoRoll = 0f;
            if (controller != null)
                RunAutopilot(flyTarg, out autoYaw, out autoPitch, out autoRoll);
        ...
        private void FixedUpdate()
        {
            ...
            // rigid.AddRelativeForce(Vector3.right*5000*h,ForceMode.Force);
